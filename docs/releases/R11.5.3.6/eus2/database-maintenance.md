...
generated_at: '2025-08-01T08:27:10.377297'
region: eus2
tags:
- eus2
- general
...
title: database-maintenance.j2 - EUS2
version: '1.0'
---


# Database Maintenance - EUS2

## Overview

Database maintenance procedure for **eastus2** region.

### Database Context

- **Target Region**: EUS2 (eastus2)
- **Environment**: eus2-production
- **Database Server**: sqldb-prod-eus2.database.windows.net
...
ansible eus2_db -m shell -a "sqlcmd -S sqldb-prod-eus2.database.windows.net -Q \"
SELECT 
...
ansible eus2_db -m shell -a "sqlcmd -Q \"
SELECT 
...
ansible eus2_db -m shell -a "sqlcmd -Q \"DBCC CHECKDB('ProductionDB') WITH NO_INFOMSGS\""
...
### Emergency Contacts
- **DBA Team**: dba-eus2@example.com
- **DevOps**: devops-eus2@example.com
