...
generated_at: '2025-08-01T08:26:37.111250'
region: scus
tags:
- scus
- general
...
title: disaster-recovery-test.j2 - SCUS
version: '1.0'
---


# Disaster Recovery Test - SCUS

## Overview

Disaster recovery test procedure for **southcentralus** region.
...
ansible scus_all -m systemd -a "name=application state=started"
ansible scus_web -m systemd -a "name=nginx state=started"
```
