...
generated_at: '2025-08-01T08:18:32.654871'
region: scus
tags:
- scus
- agent-upgrade
...
ansible scus_all -m shell -a "find /var/log -name '*.log' -mtime +14 -delete"
ansible scus_all -m shell -a "find /var/log -name '*.gz' -mtime +14 -delete"
```
